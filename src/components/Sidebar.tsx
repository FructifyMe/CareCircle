...
import { 
  Home, Users, Calendar, MessageSquare, DollarSign, Settings, 
    ...
    <div className="bg-white border-r border-gray-200 text-secondary-600 w-64 min-h-screen p-4">
      <div className="flex items-center gap-2 mb-8">
        ...
        <div>
          ...
          <span className="text-xs block text-secondary-500">Care Coordination</span>
        </div>
      </div>
      ...
      <nav className="space-y-1">
        {[
          ...
          { icon: Calendar, label: 'Shifts', value: 'shifts' },
          { icon: ClipboardList, label: 'Tasks', value: 'tasks' },
          { icon: MessageSquare, label: 'Chat', value: 'chat' },
          { icon: DollarSign, label: 'Expenses', value: 'expenses' },
          { icon: UserPlus, label: 'Add Patient', value: 'onboarding' },
      ...
      <div className="mt-8 pt-8 border-t border-gray-200">
        <div className="flex items-center gap-3 mb-6 px-3">
          ...
          <div>
            ...
            <p className="text-xs text-secondary-500">Primary Caregiver</p>
          </div>
        </div>
